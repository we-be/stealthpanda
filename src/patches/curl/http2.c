...
#define H2_CONN_WINDOW_SIZE     (15728640)  /* StealthPanda: Chrome's connection window size */
...
#define HTTP2_HUGE_WINDOW_SIZE (15728640)  /* StealthPanda: Chrome's connection window (produces WINDOW_UPDATE of 15663105) */

#define H2_SETTINGS_IV_LEN 4  /* StealthPanda: 4 settings to match Chrome */
